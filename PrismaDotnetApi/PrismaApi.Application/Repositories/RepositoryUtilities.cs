...
{
    public static ICollection<TEntity> RemoveMissingFromCollection<TEntity, TId>(ICollection<TEntity> incomingEntities, ICollection<TEntity> entities, DbContext context) where TEntity : class, IBaseEntity<TId>
    where TId : struct
    {
    ...
    public static ICollection<TEntity> AddMissingFromCollection<TEntity, TId>(ICollection<TEntity> incomingEntities, ICollection<TEntity> entities, DbContext context) where TEntity : class, IBaseEntity<TId>
    {
    ...
    public static void RemoveMissingFromCollectionMutate<TEntity, TId>(ICollection<TEntity> incomingEntities, ICollection<TEntity> entities, DbContext context) where TEntity : class, IBaseEntity<TId>
    where TId : struct
    {
        var entitiesToRemove = entities.Where(e => !incomingEntities.Any(ie => EqualityComparer<TId>.Default.Equals(ie.Id, e.Id))).ToList();
        foreach (var entityToRemove in entitiesToRemove)
