...
public interface IFastApiService
{
    ...
    Task<ApiResponseDto> SendInfluenceDiagramToFastApiAsync(Guid projectId, string endpoint, UserOutgoingDto user, bool restrictInfluenceDiagram, CancellationToken ct = default);
    ...
    Task AddMarginsToInfluenceDiagramAsync(InfluenceDiagramDto influenceDiagram, CancellationToken ct = default);
