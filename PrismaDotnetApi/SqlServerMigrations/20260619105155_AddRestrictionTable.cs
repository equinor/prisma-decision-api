        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RestrictionValue = table.Column<double>(type: "float(53)", precision: 53, nullable: false, defaultValue: 1.0),
                    ...
                    ChildOptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ChildOutcomeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RestrictionTableId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, computedColumnSql: "COALESCE([ParentOptionId], [ParentOutcomeId])", stored: true),
                    ChildStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, computedColumnSql: "COALESCE([ChildOptionId], [ChildOutcomeId])", stored: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
