            ...
            DiscreteUtility(
                ...
                parent_outcomes=[
                    DiscreteUtilityParentOutcome(
                        discrete_utility_id=utility_id, parent_outcome_id=x
                    )
                    for x in parent_outcome_ids
                ],
                parent_options=[
                    DiscreteUtilityParentOption(discrete_utility_id=utility_id, parent_option_id=x)
...
class UtilityRepository(BaseRepository[Utility, uuid.UUID]):
    def __init__(self, session: AsyncSession):
        super().__init__(
            session, Utility, query_extension_method=QueryExtensions.load_utility_with_relationships
        )
