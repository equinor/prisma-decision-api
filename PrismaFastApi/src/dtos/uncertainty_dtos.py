...
class UncertaintyMapper:
    ...
    def to_outgoing_dto(entity: Uncertainty) -> UncertaintyOutgoingDto:
        return UncertaintyOutgoingDto(
            ...
            discrete_probabilities=DiscreteProbabilityMapper.to_outgoing_dtos(
    ...
    def to_entity(dto: UncertaintyIncomingDto) -> Uncertainty:
        return Uncertainty(
            ...
            discrete_probabilities=DiscreteProbabilityMapper.to_entities(
                dto.discrete_probabilities
            ),
        )
