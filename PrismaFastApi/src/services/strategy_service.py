...
class StrategyService:
    async def create(
        ...
        await StrategyRepository(session).create(StrategyMapper.to_entities(dtos, user.id))
    ...
    async def update(
        ...
        user = await UserRepository(session).get_or_create(UserMapper.to_entity(user_dto))
        await StrategyRepository(session).update(StrategyMapper.to_entities(dtos, user.id))
