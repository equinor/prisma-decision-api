...
class UncertaintyService:
    ...
    async def recalculate_discrete_probability_table_async(
        self, session: AsyncSession, id: uuid.UUID
    ) -> Optional[UncertaintyOutgoingDto]:
        entity = await UncertaintyRepository(session).recalculate_discrete_probability_table_async(
            id
        )
